...
template void L2ColNormGrad(DTensor<GPU, float>& x, DTensor<GPU, float>& prev_grad, DTensor<GPU, float>& cur_grad, DTensor<GPU, float>& norm2, DTensor<GPU, float>& len);
template void L2ColNormGrad(DTensor<GPU, double>& x, DTensor<GPU, double>& prev_grad, DTensor<GPU, double>& cur_grad, DTensor<GPU, double>& norm2, DTensor<GPU, double>& len);
