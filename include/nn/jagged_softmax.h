#ifndef JAGGED_SOFTMAX_H
#define JAGGED_SOFTMAX_H
...
class JaggedSoftmax : public Factor
{
public:
	static std::string StrType()
	{
		return "JaggedSoftmax";
	}
	 ...
	 */
	JaggedSoftmax(std::string _name, PropErr _properr = PropErr::T);
