...
public:
    ...
    BatchNormParam(std::string _name, size_t _input_size, bool _parametrized, Dtype _eps = 1e-5, Dtype _smooth = 0.1);
    
    virtual void InitializeBatch(GraphData<mode, Dtype>* g, GraphAtt operand) override { cur_grad_output = nullptr; }
