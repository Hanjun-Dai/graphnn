...
public:
        IParam() {}
		IParam(std::string _name, GraphAtt _operand)
		{
			name = _name;
            operand = _operand;
		...
		virtual void UpdateOutput(GraphData<mode, Dtype>* input_graph, DenseMat<mode, Dtype>* output, Dtype beta, Phase phase) {}
		virtual void UpdateGradInput(GraphData<mode, Dtype>* gradInput_graph, DenseMat<mode, Dtype>* gradOutput, Dtype beta) {}						
		virtual void AccDeriv(GraphData<mode, Dtype>* input_graph, DenseMat<mode, Dtype>* gradOutput) {}
